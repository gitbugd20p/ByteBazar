            ...
            >
                ...
                <div className="space-y-4 mb-4 text-left">
                    <p className="text-gray-700">
                        ...
                        order and will ship it soon. A confirmation email with
                        your order details will be sent to your inbox shortly.
                    </p>
                    <p className="text-gray-700">
                        Order Number:{" "}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <Link
                        href="/orders"
                        className="flex items-center justify-center px-4 py-3 font-semibold  text-black border   rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-md"
                    >
